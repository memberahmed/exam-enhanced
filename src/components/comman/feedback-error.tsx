...
export default function FeedbackError({ error }: FeedbackErrorProps) {
  ...
  return (
    <>
      <div className=" relative flex items-center justify-center text-custom-red-600 font-GeistMono text-base h-10 border border-custom-red-600 bg-custom-red-50">
